...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B3YurXAA.mjs");
...
var manifest = { "3f0c3c837aabee8ab83288453c9926c1f4918840ea2465eda9abef70a5da263d": {
	functionName: "askBebok_createServerFn_handler",
	importer: () => import("./ask-bebok-CyUPM-co.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CUBLyd3V.mjs").then((n) => n.t),
